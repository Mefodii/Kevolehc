...
# FULL PATH
MAIN_MONITORS_PATH = '/'.join([INPUT_FILES_PATH, YOUTUBE_MONITOR_FILE])
SIDE_MONITORS_PATH = '/'.join([INPUT_FILES_PATH, YOUTUBE_MONITOR_FILE2])
SECONDARY_MONITORS_PATH = '/'.join([INPUT_FILES_PATH, YOUTUBE_MONITOR_SLEEP_FILE])
PGM_MONITORS_PATH = '/'.join([INPUT_FILES_PATH, YOUTUBE_MONITOR_PGM_FILE])
...
API_RESERVE_KEY_PATH = '/'.join([INPUT_FILES_PATH, YOUTUBE_DK_FILE2])
